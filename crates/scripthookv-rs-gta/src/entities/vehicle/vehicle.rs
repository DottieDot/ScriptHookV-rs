...
impl Vehicle {
  ...
  pub fn set_on_ground_properly(&self) -> bool {
    unsafe {
      vehicle::set_vehicle_on_ground_properly(self.handle, 5f32)
    }
  }
  ...
  pub fn is_stuck_on_roof(&self) -> bool {
    unsafe {
      vehicle::is_vehicle_stuck_on_roof(self.handle)
    }
  }
  ...
  pub fn is_stopped(&self) -> bool {
    unsafe {
      vehicle::is_vehicle_stopped(self.handle)
    }
  }
  ...
  pub fn explode(&self, audible: bool, invisible: bool) {
    unsafe {
      vehicle::explode_vehicle(self.handle, audible, invisible)
    }
  }
  ...
  pub fn enveff_scale(&self) -> f32 {
    unsafe {
      vehicle::get_vehicle_enveff_scale(self.handle)
    }
  }
  ...
  pub fn set_enveff_scale(&self, fade: f32) {
    unsafe {
      vehicle::set_vehicle_enveff_scale(self.handle, fade)
    }
  }
  ...
  pub fn is_siren_on(&self) -> bool {
    unsafe {
      vehicle::is_vehicle_siren_on(self.handle)
    }
  }
  ...
  pub fn set_siren_on(&self, toggle: bool) {
    unsafe {
      vehicle::set_vehicle_siren(self.handle, toggle)
    }
  }
  ...
  pub fn is_siren_audio_on(&self) -> bool {
    unsafe {
      vehicle::is_vehicle_siren_audio_on(self.handle)
    }
  }
  ...
  pub fn set_strong(&self, toggle: bool) {
    unsafe {
      vehicle::set_vehicle_strong(self.handle, toggle)
    }
  }
  ...
  pub fn set_out_of_control(&self, kill_driver: bool, explode_on_impact: bool) {
    unsafe {
      vehicle::set_vehicle_out_of_control(self.handle, kill_driver, explode_on_impact)
    }
  }
  ...
  pub fn set_forward_speed(&self, speed: f32) {
    unsafe {
      vehicle::set_vehicle_forward_speed(self.handle, speed)
    }
  }
  ...
  pub fn stop_bring_to_halt(&self) {
    unsafe {
      vehicle::_stop_bring_vehicle_to_halt(self.handle)
    }
  }
  ...
  pub fn is_being_halted(&self) -> bool {
    unsafe {
      vehicle::_is_vehicle_being_halted(self.handle)
    }
  }
  ...
  pub fn repair(&self) {
    unsafe {
      vehicle::set_vehicle_fixed(self.handle)
    }
  }
  ...
  pub fn dirt_level(&self) -> f32 {
    unsafe {
      vehicle::get_vehicle_dirt_level(self.handle)
    }
  }
  ...
  pub fn set_dirt_level(&self, dirt_level: f32) {
    unsafe {
      vehicle::set_vehicle_dirt_level(self.handle, dirt_level)
    }
  }
  ...
  pub fn is_stolen(&self) -> bool {
    unsafe {
      vehicle::is_vehicle_stolen(self.handle)
    }
  }
  ...
  pub fn set_is_stolen(&self, stolen: bool) {
    unsafe {
      vehicle::set_vehicle_is_stolen(self.handle, stolen)
    }
  }
  ...
  pub fn set_is_wanted(&self, toggle: bool) {
    unsafe {
      vehicle::set_vehicle_is_wanted(self.handle, toggle)
    }
  }
  ...
  pub fn set_needs_to_be_hotwired(&self, toggle: bool) {
    unsafe {
      vehicle::set_vehicle_needs_to_be_hotwired(self.handle, toggle)
    }
  }
  ...
  pub fn can_jump(&self) -> bool {
    match get_game_version() {
      Some(version) if version >= GameVersion::Build_944_2_Steam => unsafe { vehicle::_get_can_vehicle_jump(self.handle) },
      _ => false
    }
  }
  ...
  pub fn vehicle_class(&self) -> Option<VehicleClass> {
    unsafe {
      vehicle::get_vehicle_class(self.handle)
        .try_into()
        .ok()
    }
  }
  ...
  pub fn body_health(&self) -> f32 {
    unsafe {
      vehicle::get_vehicle_body_health(self.handle)
    }
  }
  ...
  pub fn set_body_health(&self, health: f32) {
    unsafe {
      vehicle::set_vehicle_body_health(self.handle, health)
    }
  }
  ...
  pub fn engine_health(&self) -> f32 {
    unsafe {
      vehicle::get_vehicle_engine_health(self.handle)
    }
  }
  ...
  pub fn set_engine_health(&self, health: f32) {
    unsafe {
      vehicle::set_vehicle_engine_health(self.handle, health)
    }
  }
  ...
  pub fn petrol_tank_health(&self) -> f32 {
    unsafe {
      vehicle::get_vehicle_petrol_tank_health(self.handle)
    }
  }
  ...
  pub fn set_petrol_tank_health(&self, health: f32) {
    unsafe {
      vehicle::set_vehicle_petrol_tank_health(self.handle, health)
    }
  }
  ...
  pub fn enable_radio(&self, toggle: bool) {
    unsafe {
      audio::set_vehicle_radio_enabled(self.handle, toggle)
    }
  }
  ...
  pub fn set_radio_station(&self, radio_station: &str) {
    ...
    unsafe {
      audio::set_veh_radio_station(self.handle, cstring.as_ptr())
    }
  }
  ...
  pub fn set_engine_can_degrade(&self, toggle: bool) {
    unsafe {
      vehicle::set_vehicle_engine_can_degrade(self.handle, toggle)
    }
  }
  ...
  pub fn engine_power_multiplier(&self, multiplier: f32) {
    unsafe {
      vehicle::modify_vehicle_top_speed(self.handle, multiplier)
    }
  }
  ...
  pub fn engine_torque_multiplier(&self, multiplier: f32) {
    unsafe {
      vehicle::set_vehicle_cheat_power_increase(self.handle, multiplier)
    }
  }
  ...
  pub fn is_alarm_active(&self) -> bool {
    unsafe {
      vehicle::is_vehicle_alarm_activated(self.handle)
    }
  }
  ...
  pub fn start_alarm(&self) {
    unsafe {
      vehicle::start_vehicle_alarm(self.handle)
    }
  }
  ...
  pub fn sound_horn(&self, duration: Duration) {
    unsafe {
      vehicle::start_vehicle_horn(self.handle, duration.as_millis() as i32, 0, false)
    }
  }
  ...
  pub fn turn_off_neon_lights(&self, toggle: bool) {
    unsafe {
      vehicle::_disable_vehicle_neon_lights(self.handle(), toggle)
    }
  }
  ...
  pub fn set_high_beams_on(&self, toggle: bool) {
    unsafe {
      vehicle::set_vehicle_fullbeam(self.handle, toggle)
    }
  }
  ...
  pub fn is_search_light_on(&self) -> bool {
    unsafe {
      vehicle::is_vehicle_searchlight_on(self.handle)
    }
  }
  ...
  pub fn set_search_light_on(&self, toggle: bool) {
    unsafe {
      vehicle::set_vehicle_searchlight(self.handle, toggle, false)
    }
  }
  ...
  pub fn is_taxi_light_on(&self) -> bool {
    unsafe {
      vehicle::is_taxi_light_on(self.handle)
    }
  }
  ...
  pub fn set_taxi_light_on(&self, toggle: bool) {
    unsafe {
      vehicle::set_taxi_lights(self.handle, toggle)
    }
  }
  ...
  pub fn set_right_indicator_light(&self, toggle: bool) {
    unsafe {
      vehicle::set_vehicle_indicator_lights(self.handle, 0, toggle)
    }
  }
  ...
  pub fn set_left_indicator_light(&self, toggle: bool) {
    unsafe {
      vehicle::set_vehicle_indicator_lights(self.handle, 1, toggle)
    }
  }
  ...
  pub fn set_brake_lights_on(&self, toggle: bool) {
    unsafe {
      vehicle::set_vehicle_brake_lights(self.handle, toggle)
    }
  }
}
