...
extern "C" {
  ...
  pub fn scriptRegister(module: *const c_void, LP_SCRIPT_MAIN: extern "C" fn());

  #[link_name = "?scriptRegisterAdditionalThread@@YAXPEAUHINSTANCE__@@P6AXXZ@Z"]
  pub fn scriptRegisterAdditionalThread(module: *const c_void, LP_SCRIPT_MAIN: extern "C" fn());
  ...
  pub fn worldGetAllVehicles(arr: *mut i32, arrSize: i32) -> i32;

  #[link_name = "?worldGetAllPeds@@YAHPEAHH@Z"]
  pub fn worldGetAllPeds(arr: *mut i32, arrSize: i32) -> i32;

  #[link_name = "?worldGetAllObjects@@YAHPEAHH@Z"]
  pub fn worldGetAllObjects(arr: *mut i32, arrSize: i32) -> i32;

  #[link_name = "?worldGetAllPickups@@YAHPEAHH@Z"]
  pub fn worldGetAllPickups(arr: *mut i32, arrSize: i32) -> i32;

  #[link_name = "?getScriptHandleBaseAddress@@YAPEAEH@Z"]
  pub fn getScriptHandleBaseAddress(handle: i32) -> *mut u8;
